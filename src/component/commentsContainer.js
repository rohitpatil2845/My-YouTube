...
const Comment = ({data}) => {
    const {name, text, replise} = data;
    return (
        <div className='flex h-16 shadow-sm bg-gray-200 p-2 rounded-lg my-2'>
            <img 
                alt='user'
...
//             <div className='pl-5 border border-emerald-400 ml-5'>
